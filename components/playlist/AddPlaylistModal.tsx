...
export function AddPlaylistModal() {
  ...
  const isOpen: boolean = useModalStore(
    (state) => state.isAddPlaylistModalOpen,
  );
  const closeAddPlaylistModal: () => void = useModalStore(
    (state) => state.closeAddPlaylistModal,
  );
      ...
      <div className="modalOverlay" onClick={closeAddPlaylistModal}>
        ...
        >
          ...
          <div className="addPlaylistModalMain">
            <div className="addPlaylistModalMainInputsContainer">
              {inputsData.map((item, index) => {
                return (
                  <div key={index} className="addPlaylistModalMainInput">
                    <p>{item.title}</p>
                    <input
                      key={item.title}
                      name={item.title}
          ...
          <div className="addPlaylistModalFooter">
            <button type="submit" className="addPlaylistModalFooterButton">
              Создать
            </button>
          </div>
        </form>
